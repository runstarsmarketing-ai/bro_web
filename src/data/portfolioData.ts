...
export const PORTFOLIO_PROJECTS: Project[] = [
  ...
  {
    id: 'urban-reel-sunil',
    title: 'What Should an 18-Year-Old Do in 2026? MBA, AI, Germany & Global Careers',
    category: 'Podcast',
    categoryLabel: 'Podcast',
    duration: '34:36',
    thumbnail: '',
    videoUrl: 'https://youtu.be/sgnN7tYUzs4?si=jieGnaB4Y6bXhRfb',
    description: 'A clean documentary-style edit combining strong pacing, visual storytelling, dynamic typography, b-roll, and engaging transitions to turn informational content into a compelling viewing experience.',
    client: 'Shivangi Tiwari',
    toolsUsed: ['After Effects', 'Premiere Pro'],
    featured: true,
  },
  {
