...
export const TimelineEditor: React.FC = () => {
  ...
  return (
    <div className="w-full max-w-5xl mx-auto bg-[#050505] border border-white/10 rounded-2xl sm:rounded-3xl shadow-2xl shadow-black overflow-hidden flex flex-col transition-all duration-300 hover:border-white/20">
      {/* Top Header Bar of Editor */}
      <div className="bg-zinc-900/90 backdrop-blur-xl px-3 sm:px-4 py-2 sm:py-2.5 border-b border-white/10 flex items-center justify-between text-xs text-zinc-400">
        <div className="flex items-center gap-2 sm:gap-3">
          <div className="flex items-center gap-1.5 bg-black/80 border border-white/15 px-2.5 py-0.5 rounded-lg text-white font-bold tracking-wide shadow-md">
            <span className="bg-white text-black text-[9px] px-1.5 py-0.5 rounded font-black">Pr</span>
            <span className="text-[11px] sm:text-xs">PREMIERE PRO</span>
          </div>
          <span className="hidden sm:inline-block text-zinc-600">|</span>
          <span className="text-zinc-300 font-mono hidden sm:inline-block truncate max-w-[180px] text-[11px]">
            {videoFileName}
          </span>
        </div>

        <div className="flex items-center gap-3">
          <div className="flex items-center gap-1.5 bg-black/80 px-2.5 py-0.5 rounded-lg border border-white/10 text-white font-mono font-bold text-[11px] shadow-md">
      ...
      <div className="flex flex-col lg:flex-row">
        ...
        <div className="bg-zinc-950/80 border-b lg:border-b-0 lg:border-r border-white/10 p-1.5 sm:p-2 flex lg:flex-col items-center justify-between lg:justify-start gap-1 sm:gap-1.5 text-zinc-400">
          <button
        ...
        <div className="flex-1 flex flex-col p-2.5 sm:p-3.5 gap-2.5 bg-black">
          {/* Top Video Preview Display Monitor - Compact Height for Laptop Screen */}
          <div className="relative aspect-video w-full max-w-[520px] max-h-[220px] sm:max-h-[250px] md:max-h-[270px] mx-auto bg-[#030303] rounded-xl sm:rounded-2xl overflow-hidden border border-white/10 group shadow-2xl flex items-center justify-center">
            ...
            <div className="absolute top-2 right-2 flex items-center gap-1.5 bg-black/80 backdrop-blur-xl border border-white/10 px-2.5 py-0.5 rounded-full text-[10px] text-zinc-300 shadow-xl">
            ...
            <button
              ...
              className="absolute inset-0 m-auto w-12 h-12 rounded-full bg-white text-black flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all duration-300 hover:scale-110 shadow-2xl shadow-white/30"
            >
              {isPlaying ? <Pause className="w-5 h-5 fill-current" /> : <Play className="w-5 h-5 fill-current ml-0.5" />}
            </button>

            {/* Controls Bar bottom overlay */}
            <div className="absolute bottom-2 left-2 right-2 flex items-center justify-between text-xs text-white bg-black/85 backdrop-blur-xl px-3 py-1.5 rounded-lg border border-white/15 shadow-2xl">
          ...
          {/* Timeline Section */}
          <div className="bg-zinc-950/80 border border-white/10 rounded-xl p-2.5 sm:p-3 flex flex-col gap-2 backdrop-blur-xl">
            {/* Ruler Header with Timecode notches */}
            <div
              className="relative h-5 bg-zinc-900 rounded-lg border border-white/10 cursor-pointer overflow-hidden select-none"
            ...
            >
              ...
              >
                <div className="w-2 h-2 bg-white border border-black rotate-45 -translate-x-[3px] -translate-y-0.5 rounded-xs" />
              </div>
            </div>
            ...
            <div className="flex flex-col gap-1.5 relative">
              ...
              <div className="flex items-center gap-2 h-8">
                <div className="w-16 sm:w-20 bg-zinc-900 border border-white/10 rounded-lg px-2 py-0.5 flex items-center justify-between text-[10px] font-bold text-zinc-300 shrink-0">
                ...
                >
                  <div
                    className={`absolute top-0.5 bottom-0.5 rounded-md px-2.5 flex items-center text-[10px] font-semibold text-white transition-opacity ${
              ...
              <div className="flex items-center gap-2 h-8">
                ...
                >
                  <div
                    className={`absolute top-0.5 bottom-0.5 rounded-md px-2.5 flex items-center gap-1.5 text-[10px] font-semibold text-white transition-opacity ${
                      v1Visible ? 'bg-zinc-700/80 border border-white/20 shadow-sm' : 'bg-zinc-900 opacity-30'
                    }`}
                    style={{ left: '0%', width: '100%' }}
                  >
                    <div className="flex items-center gap-1.5 overflow-hidden">
                      <Video className="w-3 h-3 text-zinc-300 shrink-0" />
              ...
              <div className="flex items-center gap-2 h-8">
                ...
                >
                  <div
                    className={`absolute top-0.5 bottom-0.5 rounded-md px-2.5 flex items-center gap-2 text-[10px] font-medium text-emerald-100 transition-opacity ${
